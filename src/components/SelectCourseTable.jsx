...
const SelectCourseTable = (props) => {
  const { loading, courses, selectedCourses, sendCourse } = props;
              ...
              <i
                className={`btn add_button me-3 mt-2 ${
                  selectedCourses.find(
                    (selectedCourse) =>
                      selectedCourse._id === props.cell.row.original._id
                  )
                    ? "btn-success"
                    : "btn-primary"
                }`}
